...
- Shared data-freshness language across views.
- Weekly action queue with state and direct evidence links.
- Simplified Sync recommendations and failure recovery.
