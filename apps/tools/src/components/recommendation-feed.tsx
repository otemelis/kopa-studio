...
export type RecommendationFeedItem = {
  id: string;
  source: "ASO" | "Apple Ads" | "Discovery";
  appName: string | null;
  title: string;
  whatHappened: string;
